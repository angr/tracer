...
bin_location = str(os.path.join(os.path.dirname(os.path.realpath(__file__)), '../../binaries/tests'))
...
def test_recursion():
    t = tracer.Tracer(os.path.join(bin_location, "cgc", "CROMU_00071"), open('crash2731', 'rb').read())
